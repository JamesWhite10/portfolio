            ...
            <div className={`${styleContainer.container} ${style.contactsContainer}`}>
                ...
                <form className={style.data}>
                   <div><img className={style.icon} src={"https://icon-library.com/images/phone-white-icon/phone-white-icon-23.jpg"} alt={"telephone"}/>+7 960 607 25 08</div>
                    ...
                    <div><img className={style.icon} src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTB-BB0ED7kp7stB94xjUw1la8MVXvBq-GKtQ&usqp=CAU"} alt={"linkedin"}/>www.linkedin.com/in/maxmigalin10</div>
